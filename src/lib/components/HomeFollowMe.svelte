...
<div class="content-wrapper p-5">
	<div
		id="hp_ig_feed_wrap"
		class="wrapper text-center pt-[105px] pb-[75px] flex lg:justify-center lg:space-x-20 flex-col lg:flex-row items-center space-y-5 lg:space-y-0 max-w-[900px] w-full m-auto"
	>
		<div class="follow-me-wrapper">
			...
			>
				...
				<div class="inline-block">
					<div class="font-barlow title-container items-start flex flex-col">
						<MiniLogo />
						<h2
							class="mt-3 text-header uppercase font-medium text-black leading-[56px] xl:text-[90px] relative text-center tracking-tighter text-[50px]"
						>
							follow
						</h2>
			...
			<div class="button-container mt-14 md:mt-20" use:getAnim="{'fade-in-up'}">
				<a
		...
		<div class="insta-embed-wrapper w-full flex justify-center">
			<blockquote
				class="instagram-media"
				data-instgrm-permalink="https://www.instagram.com/scottjamesluxuryestates/?utm_source=ig_embed&amp;utm_campaign=loading"
			...
			>
				<div style="padding:16px;">
					<a
						href="https://www.instagram.com/scottjamesluxuryestates/?utm_source=ig_embed&amp;utm_campaign=loading"
					...
					>
						<a
							...
							target="_blank">𝐒𝐜𝐨𝐭𝐭 𝐉𝐚𝐦𝐞𝐬 | Luxury Realtor®</a
						>
						(@<a
							href="https://www.instagram.com/scottjamesluxuryestates/?utm_source=ig_embed&amp;utm_campaign=loading"
							style=" color:#c9c8cd; font-family:Arial,sans-serif; font-size:14px; font-style:normal; font-weight:normal; line-height:17px;"
							target="_blank">scottjamesluxuryestates</a
